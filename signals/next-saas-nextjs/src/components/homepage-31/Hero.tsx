...
const Hero = () => {
  return (
    <section className="md:mt-4 lg:mt-6 xl:mt-[30px]">
      <div className="max-w-[1860px] mx-auto pt-[170px] sm:pt-[190px] md:pt-[210px] lg:pt-[220px] pb-[80px] sm:pb-[100px] lg:pb-[200px] min-h-[600px] md:max-h-[940px] md:rounded-[30px] xl:rounded-[50px] relative overflow-hidden">
        <video
        ...
        <div className="main-container relative z-10">
          <div className="space-y-3 md:space-y-5 text-center md:text-left max-w-full md:max-w-[666px]">
            <RevealAnimation delay={0.1}>
              <span className="inline-block text-xs sm:text-tagline-2 font-medium backdrop-blur-[18px] rounded-full px-3 sm:px-5 py-1.5 bg-accent/10 text-primary-50 dark:text-ns-green">
                Keep an eye on your finances
              </span>
            </RevealAnimation>
            <div className="space-y-2.5 md:space-y-4">
              <RevealAnimation delay={0.2}>
                <h1 className="max-w-full md:max-w-[666px] leading-[1.2] text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <RevealAnimation delay={0.3}>
                <p className="text-accent/60 max-w-full md:max-w-[580px] text-sm sm:text-base px-4 md:px-0">
              ...
              <ul className="flex flex-col flex-wrap sm:flex-row items-center sm:items-start md:items-center gap-y-3 gap-x-4 sm:gap-x-9 mt-8 md:mt-[54px] px-4 md:px-0">
                <RevealAnimation delay={0.4}>
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-accent/60 text-xs sm:text-tagline-2"> Automated time tracking </span>
                  </li>
                </RevealAnimation>
                <RevealAnimation delay={0.5}>
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-accent/60 text-xs sm:text-tagline-2"> In-depth productivity reports </span>
                  </li>
                </RevealAnimation>
                <RevealAnimation delay={0.6}>
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-accent/60 text-xs sm:text-tagline-2"> Effortless project management </span>
                  </li>
                </RevealAnimation>
              </ul>
            </div>
