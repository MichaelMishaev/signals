      ...
      <section className="pt-20 pb-20 md:pb-28 xl:pb-[160px] bg-background-2 dark:bg-background-5">
        <div className="main-container">
          <div className="space-y-10 md:space-y-[70px]">
            ...
            {/* features grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-y-10 md:gap-x-8 px-4 sm:px-0">
              {featuresData.map((feature, index) => (
                <RevealAnimation key={feature.id} delay={0.3 + index * 0.1}>
                  {feature.isMainCard ? (
                    <article className="md:col-span-2 lg:col-span-12 bg-white dark:bg-background-6 min-h-[350px] md:min-h-0 md:max-h-[400px] lg:max-h-[319px] overflow-hidden relative rounded-[20px] flex flex-col lg:flex-row justify-between items-center pt-8 px-4 md:px-8">
                      <RevealAnimation delay={0.3 + index * 0.1 + 0.1}>
                        <div>
                          <h3 className="text-xl sm:text-2xl md:text-heading-5 mb-1">{feature.title}</h3>
                    ...
                    <article className="space-y-3 md:col-span-1 lg:col-span-4 rounded-[20px] p-4 bg-white dark:bg-background-6">
                      {feature.image && (
                      ...
                      <div className="space-y-1">
                        <h3 className="text-xl sm:text-2xl md:text-heading-5">{feature.title}</h3>
                        <p className="text-sm sm:text-base">{feature.description}</p>
