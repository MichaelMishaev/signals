...
if (!global.mockSignalsStore) {
  global.mockSignalsStore = [
    ...
    // Real Market Signals - January 2025 (Based on current market research)
    {
      id: 8,
      title: "EUR/USD Bearish Continuation",
      content: "EUR/USD faces bearish pressure as technical indicators suggest further declines after breaking below key moving averages. RSI at 43 indicates potential for additional weakness. Strong resistance near 1.0920.",
      pair: "EURUSD",
      action: "SELL" as const,
      entry: 1.0865,
      stop_loss: 1.0920,
      ...
      author_image: null,
      chart_image: null,
      key_levels: { resistance: [1.0920, 1.0950, 1.1000], support: [1.0810, 1.0780, 1.0750] },
      analyst_stats: { successRate: 87, totalSignals: 178, totalPips: 2890 },
      created_at: new Date(Date.now() - 12600000).toISOString(), // 3.5 hours ago
      updated_at: new Date(Date.now() - 12600000).toISOString(),
      published_date: new Date(Date.now() - 12600000).toISOString(),
    },
    {
      id: 9,
      title: "Bitcoin Bullish Momentum to $120K",
      content: "Bitcoin showing strong bullish momentum with institutional support. Breaking above $103,900 resistance could trigger move toward $120,000. Galaxy Research predicts BTC to exceed $150K in early 2025.",
      pair: "BTCUSD",
      action: "BUY" as const,
      entry: 103900,
      stop_loss: 100500,
      take_profit: 120000,
      current_price: 103900,
      confidence: 88,
      market: "CRYPTO",
      status: "ACTIVE",
      pips: 0,
      ...
      author_image: null,
      chart_image: null,
      key_levels: { resistance: [110000, 120000, 130000], support: [100500, 95000, 90000] },
      analyst_stats: { successRate: 84, totalSignals: 245, totalPips: 3420 },
    ...
    {
      id: 10,
      title: "Gold Bullish Breakout Above $2,675",
      content: "Gold testing key support at $2,675 with strong bullish structure. Ascending channel pattern intact with Fibonacci support at 23.6% level. Breakout above $2,710 could push toward $2,745.",
      pair: "XAUUSD",
      action: "BUY" as const,
      entry: 2675.00,
      stop_loss: 2648.50,
      ...
      author_image: null,
      chart_image: null,
      key_levels: { resistance: [2710.00, 2745.00, 2780.00], support: [2648.50, 2620.00, 2590.00] },
      analyst_stats: { successRate: 91, totalSignals: 156, totalPips: 4100 },
      created_at: new Date(Date.now() - 16200000).toISOString(), // 4.5 hours ago
      updated_at: new Date(Date.now() - 16200000).toISOString(),
      published_date: new Date(Date.now() - 16200000).toISOString(),
    }
  ];
}
